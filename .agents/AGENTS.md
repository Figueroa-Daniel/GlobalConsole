...
Este archivo actúa como el punto de entrada principal para la configuración del agente en este workspace. 

Por favor, lee y aplica estrictamente las reglas definidas en los siguientes archivos de configuración:
