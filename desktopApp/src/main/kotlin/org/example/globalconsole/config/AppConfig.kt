...
/**
 * Modelo unificado de configuración de la aplicación GlobalConsole. Representa el contenido
 * completo del archivo `config.json` en el directorio de trabajo de la aplicación.
 *
 * Todos los repositorios que persisten datos en `config.json` deben leer este objeto completo antes
 * de escribir, modificar únicamente su propio campo y reescribir el objeto entero, para evitar que
 * una escritura parcial destruya los datos de otro módulo.
 *
